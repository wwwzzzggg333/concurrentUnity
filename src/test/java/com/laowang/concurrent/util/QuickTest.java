...
public class QuickTest {
    public static void main(String[] args) {
        ...
        try {
            ...
            LockStat stat1 = LockUtils.lock(lock1);
            ...
            LockStat stat2 = LockUtils.tryLock(lock2, 1L, TimeUnit.SECONDS);
            ...
            lock3.lock();
            LockStat stat3 = LockUtils.tryLock(lock3, 10L, TimeUnit.MILLISECONDS);
            ...
            try (LockStat stat4 = LockUtils.lock(lock4)) {
